...
def test_LC_explore_example():
    ...
    data = {
        'nodes': [
            ...
            {
                'edges': [(0, 2, 1), (0, 3, 1), (0, 4, 1), (1, 2, 1), (1, 3, 1), (1, 4, 1), (2, 3, 1), (2, 4, 1)],
                'id': 6
            },
            {
                'edges': [(0, 1, 1), (0, 2, 1), (0, 3, 1), (0, 4, 1), (1, 2, 1), (1, 3, 1), (1, 4, 1), (3, 4, 1)],
                'id': 7
            },
...
def test_prime_dimension_explore_example():
    ...
    cg_data = export_class_graph(class_graph, filename)
