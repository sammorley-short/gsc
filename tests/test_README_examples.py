    ...
    data = {'nodes':
            [{'edges': [(0, 1, 1), (1, 2, 1), (2, 3, 1), (3, 4, 1)], 'id': 0},
             ...
             {'edges': [(0, 1, 1), (0, 2, 1), (0, 3, 1),
                        (1, 2, 1), (1, 3, 1), (3, 4, 1)], 'id': 3},
             {'edges': [(0, 2, 1), (0, 3, 1), (1, 2, 1),
                        (1, 3, 1), (3, 4, 1)], 'id': 4},
             {'edges': [(0, 2, 1), (0, 3, 1), (0, 4, 1), (1, 2, 1),
                        (1, 3, 1), (1, 4, 1), (3, 4, 1)], 'id': 5},
             {'edges': [(0, 2, 1), (0, 3, 1), (0, 4, 1), (1, 2, 1),
                        (1, 3, 1), (1, 4, 1), (2, 3, 1), (2, 4, 1)], 'id': 6},
             {'edges': [(0, 1, 1), (0, 2, 1), (0, 3, 1), (0, 4, 1),
                        (1, 2, 1), (1, 3, 1), (1, 4, 1), (3, 4, 1)], 'id': 7},
             {'edges': [(0, 1, 1), (0, 2, 1), (0, 3, 1),
                        (0, 4, 1), (2, 3, 1), (2, 4, 1)], 'id': 8},
...
def test_prime_dimension_explore_example():
    ...
    data = {'nodes':
            ...
            [{'source': 0, 'equivs': [[1]], 'target': 0, 'ops': ['EM2']},
             ...
             {'source': 0, 'equivs': [[1], [1, 0]],
                 'target': 2, 'ops': ['LC1', 'LC2']},
             {'source': 0, 'equivs': [[1], [1, 2]],
                 'target': 3, 'ops': ['LC2', 'LC1']},
             {'source': 0, 'equivs': [[2]], 'target': 4, 'ops': ['EM2']},
             {'source': 1, 'equivs': [[2], [1]],
                 'target': 2, 'ops': ['LC2', 'LC1']},
             {'source': 1, 'equivs': [[1]], 'target': 4, 'ops': ['EM2']},
             {'source': 1, 'equivs': [[1, 0, 2], [1]],
                 'target': 6, 'ops': ['LC1', 'LC2']},
             {'source': 2, 'equivs': [[1, 0]], 'target': 2, 'ops': ['EM2']},
             {'source': 2, 'equivs': [[1, 2], [1, 0]],
                 'target': 3, 'ops': ['LC2', 'LC1']},
             {'source': 2, 'equivs': [[1, 0, 2]], 'target': 5, 'ops': ['EM2']},
             {'source': 2, 'equivs': [[1, 0, 2], [2]],
                 'target': 6, 'ops': ['LC2', 'LC1']},
             {'source': 3, 'equivs': [[1, 2]], 'target': 3, 'ops': ['EM2']},
             {'source': 3, 'equivs': [[1], [0]],
                 'target': 4, 'ops': ['LC2', 'LC1']},
             {'source': 3, 'equivs': [[1, 0, 2], [0]],
